...
const Register = ({ checkEmail }) => {
  ...
  const handleChange = (e) => {
    ...
    switch (e.target.name) {
      ...
      case "email":
        ...
        setErrors({
          ...errors,
          emailError: checkEmail(val) ? null : messages.mailMsg,
        });
        break;
      case "confirmEmail":
  ...
  const isInCorrectInputs = (obj) =>
    obj.name === "" ||
    obj.name.length < 5 ||
    obj.surname.length < 5 ||
    obj.surname === "" ||
    obj.phone === "" ||
    obj.email === "" ||
    obj.confirmEmail === "" ||
  ...
  const checkValidity = () => {
    ...
    setErrors({
      ...
      surnameError:
        surname === "" ? isReq : surname.length < 5 ? isShort : null,
    ...
    <Collapse in={true}>
      <Grid spacing={2} className="container-radio">
        ...
        >
          <FormControlLabel
            value="M."
            control={<Radio sx={customStyles.customRadioStyle} />}
            label="M."
          />
          <FormControlLabel
            value="Mme"
      ...
      <Grid container alignItems={"center"} spacing={2} mt={0.3} mb={0.2}>
        ...
        <Grid>
          J'accepte les <span className="cgu">conditions générales</span>
        </Grid>
      </Grid>
      <Grid container spacing={2} mt={2}>
        ...
        <Grid className="input-box-left" item md={6} xs={12}>
          <Button
            className={
              !isInCorrectInputs(formData)
                ? "input-box_button"
                : "input-box_button-disabled"
            }
